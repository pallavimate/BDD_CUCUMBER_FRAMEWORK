...
public class SwagLabRemoveScenarioSteps
{
    ...
    @When("user click on add to cart option for the product sauce labs bike light")
    public void user_click_on_add_to_cart_option_for_the_product_sauce_labs_bike_light() {
        home.AddToCartsauceLabBikeLightSwagLabHomePage();
    }
    ...
    @When("remove sauce labs backpack")
    public void remove_sauce_labs_backpack() {
        cart.RemovebackpackSwagLabYourCartPage();
    }
